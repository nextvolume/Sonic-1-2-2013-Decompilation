...
## DOS/DJGPP:
* Install DJGPP (or a DJGPP cross compiler) and Allegro 4.2
* When running make add 'USE_ALLEGRO4=1 DOS=1' to the command line
...
I (nextvolume) have also added an Allegro 4.x backend, allowing the engine to run, for instance, on DOS; the Allegro currently lacks many features such as audio, user selectable bindings, etc.
